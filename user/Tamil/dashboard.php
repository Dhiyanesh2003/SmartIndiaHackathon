...
<br><header>
        ...
        <div>
            ...
            <b><h1>&nbsp;&nbsp;&nbsp;விண்ணப்பதாரர் &nbsp; விவரம்</h1></b>       <div>
    </header>
    <main>
    <br><br><br>
		...
		<?php
			$id=$_SESSION["id"];
			echo "<input class='idd' value='கே.எண் : ".$id."' disabled>";
		?>
        <br class="br">
        <br class="br">
        <br class="br">
        <br class="br">
        <br class="br">
        <a class="butto" href="terms.html">+ புதிய விண்ணப்பம்</a>
						...
						<?php
							...
							if ($result->num_rows > 0) {
							  ...
							  while($row = $result->fetch_assoc()) {
                                if($row['status']=='0'){
                                    $status='விண்ணப்பிக்கபட்டுள்ளது';
                                    $class="yellow";
                                }
                                else if($row['status']=='1'){
                                    $status='எந்த நேரத்திலும் ஆய்வு<br>எதிர்பார்க்கப்படுகிறது';
                                    $class="orange";
                                }
                                else if($row['status']=='-1'){
                                    $status='மறுக்கப்பட்டது';
                                    $class="red";
                                }
                                else if($row['status']=='2'){
                                    $status='நிதிக்கு தயார்';
                                    $class="blue";
                                }
                                else if($row['status']=='-2'){
                                    $status=' ஆய்வுக்கு பின்பு மறுக்கப்பட்டது';
                                    $class="red";
                                }
                                else if($row['status']=='3'){
                                    $status='திட்டம் நிதியுதவி';
                                    $class="purple";
                                }
                                else if($row['status']=='4'){
                                    $status='காலக்கெடு கடந்துவிட்டது<br>எந்த நேரத்திலும் ஆய்வு எதிர்பார்க்கப்படுகிறது';
                                    $class="violet";
                                }
                                else if($row['status']=='5'){
                                    $status='திட்டம் நிறைவடைந்து விட்டது';
                                    $class="green";
                                }
                                else if($row['status']=='-3'){
                                    $status='திட்டம் சீல் வைக்கப்பட்டது';
                                    $class="red";
                                }
								echo "
								<tr>
