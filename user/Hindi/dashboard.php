...
<br><header>
    ...
    <br><br><br>
        ...
        <br class="br">
        <br class="br">
        <a class="butto" href="terms.html">+ नए आवेदन</a>
						...
						<?php
							...
							if ($result->num_rows > 0) {
							  ...
							  while($row = $result->fetch_assoc()) {
                                if($row['status']=='0'){
                                    $status='सफलतापूर्वक लागू किया गया';
                                    $class="yellow";
                                }
                                else if($row['status']=='1'){
                                    $status='निरीक्षण अपेक्षित<br>किसी भी समय';
                                    $class="orange";
                                }
                                else if($row['status']=='-1'){
                                    $status='किसी भी समय';
                                    ...
                                    $status='फंडिंग के लिए तैयार';
                                    $class="blue";
                                }
                                else if($row['status']=='-2'){
                                    $status='निरीक्षण के बाद मना कर दिया';
                                    $class="red";
                                }
                                else if($row['status']=='3'){
                                    $status='परियोजना वित्त पोषित';
                                    $class="purple";
                                }
                                else if($row['status']=='4'){
                                    $status='समय सीमा पार<br>कभी भी निरीक्षण अपेक्षित';
                                    $class="violet";
                                }
                                else if($row['status']=='5'){
                                    $status='परियोजना पूर्ण';
                                    $class="green";
                                }
                                else if($row['status']=='-3'){
                                    $status='परियोजना मुहरबंद';
                                    $class="red";
                                }
								echo "
								<tr>
